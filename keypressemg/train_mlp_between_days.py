...
from datasets.split_between_days_dataset import get_split_between_days_dataset
from models.feature_model import FeatureModel
from train_utils import train, config_wandb
...
def main(args):
    ...
    for p in Participant:
        ...
        acc, history = train(args, model, train_loader, eval_loader, optimizer, log_prefix=f'{p.value}')
