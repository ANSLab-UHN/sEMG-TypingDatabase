...
import keypressemg.fl_trainers.trainer_FedAvg_between_days
from keypressemg.common.utils import config_logger
from sweeps.sweep_utils import sweep
...
def get_command_line_arguments(parser):
    ...
    parser.add_argument("--app-name", type=str, default=f"sweep_Fed_Avg_between_days")
...
if __name__ == '__main__':
    argument_parser = argparse.ArgumentParser(description="Sweep FedAvg Between Days Train Key Press EMG MLP")
    ...
    sweep(sweep_config=sweep_configuration, args=cli_args,
          train_fn=keypressemg.fl_trainers.trainer_FedAvg_between_days.train)
