...
import keypressemg.fl_trainers.trainer_FedPer_split_day
...
if __name__ == '__main__':
    argument_parser = argparse.ArgumentParser(description="Sweep FedPer Split Day Train Key Press EMG MLP")
    ...
    sweep_configuration = {
        "name": "sweep_FedPer_split_day_key_press_emg",
        "method": "grid",
        ...
        "parameters": {
            ...
            "num_personalization_layers": {"values": [1, 2]},
        },
    }
    sweep(sweep_config=sweep_configuration, args=cli_args,
          train_fn=keypressemg.fl_trainers.trainer_FedPer_split_day.train)
