...
@torch.no_grad()
def eval_model(args, global_model, client_ids):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--app-name", type=str, default=f"train_FedAvg_mlp_split_day")
    ...
    exp_name = f'FedAvg_split-day_seed_{args.seed}_wd_{args.wd}_' \
